...
import cmp_bookpedia.composeapp.generated.resources.ratings
                ...
                if (state.isLoading) {
                    Column(modifier = Modifier.fillMaxHeight()) {
                        Box(
                            modifier = Modifier
                                .fillMaxWidth()
                                .weight(1f),  // Now weight works because Box is direct child of Column
                    ...
                    Text(
                        text = if (state.book.description.isNullOrBlank()) {
                            val stringResource = stringResource(Res.string.description_unavailable)
                            stringResource
                        } else {
